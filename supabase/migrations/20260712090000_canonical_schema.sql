...
begin
  for item in
    ...
    where schemaname = 'public'
      and tablename in (
        'threads', 'files', 'thread_files', 'upload_sessions', 'chat_messages',
        'thread_seq', 'shared_conversations', 'agents', 'scheduled_triggers',
        'trigger_execution_logs', 'user_profiles', 'slide_presentations',
        'user_integrations', 'integration_action_logs'
      )
  loop
