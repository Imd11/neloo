    ...
    <form onSubmit={handleSubmit} className="space-y-5">
      ...
      <div className="relative my-6">
        ...
        <div className="relative flex justify-center text-xs uppercase">
          <span className="bg-[hsl(var(--auth-card))] px-2 text-[hsl(var(--auth-muted-foreground))]">
            Or continue with
          </span>
        </div>
      </div>
      ...
      <Button
        type="button"
        variant="outline"
        className="w-full h-11 border-[hsl(var(--auth-border))] hover:bg-[hsl(var(--auth-accent))] text-[hsl(var(--auth-foreground))]"
        onClick={() => {
