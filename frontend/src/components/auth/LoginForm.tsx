  ...
  return (
    <div className="space-y-7">
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        <div className="space-y-2">
          <Label htmlFor="email" className="text-[13px] font-medium text-[hsl(var(--foreground))]">
            Email address
          </Label>
          <Input
            id="email"
        ...
        <div className="space-y-2">
          <div className="flex items-center justify-between">
            <Label htmlFor="password" className="text-[13px] font-medium text-[hsl(var(--foreground))]">
              Password
            </Label>
            <button type="button" className="text-[13px] text-[hsl(var(--primary))] hover:text-[hsl(var(--primary)/0.8)] transition-colors">
              Forgot password?
            </button>
          </div>
          <div className="relative">
