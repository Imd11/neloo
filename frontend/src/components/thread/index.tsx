...
import { useDataFileUpload } from "@/hooks/use-data-file-upload";
...
export function Thread() {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    let uploadedFiles = fileUpload.uploadedFiles;
    if (fileUpload.files.some((f) => f.status === "pending")) {
      uploadedFiles = await fileUpload.uploadFiles();
    }
                    ...
                    <div className="flex items-center justify-between p-2 pt-4">
                      <div className="flex items-center gap-3 flex-wrap">
                        ...
                        <DataFileUpload
                          ...
                          onTriggerSelect={fileUpload.triggerFileSelect}
                      ...
                      {stream.isLoading ? (
                        ...
                        <Button
                          ...
                          disabled={isLoading || (!input.trim() && fileUpload.files.length === 0)}
                        >
                          Send
                        </Button>
                      )}
