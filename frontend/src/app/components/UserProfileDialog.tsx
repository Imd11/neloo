...
import { User, Edit2, Check, X, Crown, Zap, Clock } from "lucide-react";
import {
  Dialog,
  DialogContent,
  DialogHeader,
...
const profileTabs = [{ id: "account", label: "Account", icon: User }];
        ...
        return (
          <div className="space-y-6">
            ...
            <div className="flex items-center gap-4 rounded-xl bg-accent/50 p-4">
              <div className="flex h-16 w-16 items-center justify-center rounded-full bg-gradient-to-br from-blue-500 to-purple-500 text-xl font-medium text-white">
