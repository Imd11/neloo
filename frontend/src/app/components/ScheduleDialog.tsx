...
import { useTriggers, CRON_PRESETS } from "@/app/hooks/useTriggers";
    ...
    >
      <DialogContent className="sm:max-w-[500px]">
        <DialogHeader>
          ...
          <DialogDescription>设置智能体自动执行的时间规则</DialogDescription>
        </DialogHeader>
                  ...
                  <div className="flex-1">
                    <div className="flex items-center gap-2">
                      <span className="text-sm font-medium">
                        {CRON_PRESETS.find(
                          (p) => p.value === trigger.cron_expression
                        )?.label || trigger.cron_expression}
                      </span>
                      <span
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <Select
                  ...
                  onValueChange={(v) => setNotificationMethod(v as any)}
                >
                  <SelectTrigger>
                    <SelectValue />
                  </SelectTrigger>
