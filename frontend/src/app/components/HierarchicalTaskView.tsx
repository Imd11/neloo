...
export function HierarchicalTaskView({
  ...
  const allAiContent = useMemo(() => {
    ...
    return aiMessages
      .map((m) => extractStringFromMessageContent(m))
      .join("\n\n");
  }, [messages]);
    ...
    <div className="space-y-3">
      <div className="space-y-0">
        {timeline.events.map((evt: EventTimelineEvent, idx: number) => {
          ...
          const contentKey = (evt.item as any)?.id || `content-${idx}`;
            ...
            return (
              ...
              >
                ...
                <div className="flex w-4 shrink-0 justify-center">
                  <div className="-my-1.5 h-[calc(100%+12px)] w-px bg-border" />
                </div>
                <div className="ml-1 min-w-0 flex-1 py-0.5">
