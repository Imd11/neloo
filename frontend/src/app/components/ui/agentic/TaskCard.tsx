...
export function TaskCard({
  ...
  return (
    <div className={cn("group relative font-sans", className)}>
      ...
      {title && (
        <div
          className={cn(
            "relative flex cursor-pointer select-none items-center gap-3 py-1 transition-colors",
        ...
        >
          ...
          {/* Title Area */}
          <div className="flex min-w-0 flex-1 items-center gap-2 rounded-md p-1 transition-colors hover:bg-zinc-50 dark:hover:bg-zinc-900/50">
            <span
              className={cn(
                "flex-1 truncate text-[14px] font-medium tracking-tight text-zinc-900 dark:text-zinc-100",
                status === "completed" &&
            ...
            <span
              className={cn(
                "text-zinc-300 transition-colors group-hover/header:text-zinc-400 dark:text-zinc-600",
