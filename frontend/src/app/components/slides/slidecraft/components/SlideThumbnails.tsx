                ...
                return (
                    ...
                    >
                        ...
                        >
                            ...
                            <div className="absolute inset-0 flex items-end p-2 bg-gradient-to-t from-black/90 to-transparent opacity-0 hover:opacity-100 pointer-events-none">
                        ...
                        {!isDragging && (
                            <>
                                ...
                                <button
                                    ...
                                    className="absolute -bottom-3 left-1/2 -translate-x-1/2 z-50 w-6 h-6 rounded-full bg-purple-600 text-white flex items-center justify-center opacity-0 group-hover/thumbnail:opacity-100 transition-all hover:scale-110 shadow-lg cursor-pointer"
