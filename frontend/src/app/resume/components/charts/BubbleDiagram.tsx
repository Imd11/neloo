...
export function BubbleDiagram({ centerLabel, items, primaryColor = '#0e5484' }: BubbleDiagramProps) {
    ...
    return (
        <div className="bubble-diagram" style={{ width: '100%', maxWidth: '200px', margin: '0 auto' }}>
