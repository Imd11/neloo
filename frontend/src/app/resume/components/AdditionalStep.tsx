...
export function AdditionalStep({
  ...
  const [acceptedModules, setAcceptedModules] = useState<Set<ModuleKey>>(
    new Set()
  );
  ...
  const addAward = () => {
    onChange({
      ...
      awards: [
        ...data.awards,
        { id: createId(), title: "", issuer: "", date: "", description: "" },
      ],
    });
  };
  ...
  const addHobby = () => {
    onChange({
      ...
      hobbies: [
        ...data.hobbies,
        { id: createId(), name: "", icon: "", description: "" },
      ],
    });
  };
  ...
  const renderExistingModuleCard = (moduleKey: ModuleKey) => {
    ...
    return (
      <div
        key={moduleKey}
        className="module-card existing"
      >
        <div
        ...
        {isExpanded && (
          <div className="module-content">{renderModuleForm(moduleKey)}</div>
        )}
      </div>
    );
  };
