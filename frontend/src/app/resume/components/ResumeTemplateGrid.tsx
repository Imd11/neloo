...
const categoryColors: Record<string, string> = {
    ...
    modern: 'bg-orange-100 text-orange-700 dark:bg-orange-900/30 dark:text-orange-400',
};
...
export function ResumeTemplateGrid({ activeTemplate, onSelectTemplate }: ResumeTemplateGridProps) {
    const pagePreset = getPagePreset(defaultStyleSettings.pageSize);

    return (
        <div className="w-full">
            <h3 className="text-sm font-medium text-muted-foreground mb-4">选择模板</h3>
                    ...
                    return (
                        ...
                        >
                            ...
                            <div className="aspect-[3/4] bg-muted relative overflow-hidden">
                                ...
                                {/* Active Badge */}
                                {isActive && (
                                    <div className="absolute top-2 right-2 bg-primary text-primary-foreground text-xs px-2 py-0.5 rounded-full font-medium z-10">
                                        ✓
                                    </div>
                                )}
                            ...
                            <div className="p-2.5 bg-card">
                                <h4 className="text-xs font-semibold text-foreground truncate">{template.name}</h4>
