...
import { getLabelUpper } from "../../lib/i18n/resumeLabels";
...
export function MinimalCVTemplate({
  ...
  const showPublications =
    visibility?.publications ?? data.publications.length > 0;
  const showAwards = visibility?.awards ?? data.awards.length > 0;
  const showCertificates =
    visibility?.certificates ?? data.certificates.length > 0;
    ...
    >
      ...
      <aside className="minimal-sidebar">
            ...
            <div className="minimal-info-item">
              ...
              <span>
                ...
                <EditableText
                  ...
                  onChange={
                    onDataChange
                      ? (v) => updatePersonal("nationality", v)
                      : undefined
                  }
              ...
              >
                ...
                <span>
                  <EditableText
                    ...
                    onChange={
                      onDataChange
                        ? (v) => updateSocialLink(i, "platform", v)
                        : undefined
                    }
                  ...
                  <EditableText
                    ...
                    onChange={
                      onDataChange
                        ? (v) => updateSocialLink(i, "username", v)
                        : undefined
                    }
        ...
        {data.languages.length > 0 && (
          <section className="minimal-section">
            <h3 className="minimal-section-title">
              {getLabelUpper("languages", lang)}
            </h3>
            {data.languages.map((langItem, i) => (
              <div
                key={langItem.id}
                className="minimal-lang-item"
              >
      ...
      <main className="minimal-main">
        ...
        {data.education.length > 0 && (
          <section className="minimal-main-section">
            <h2 className="minimal-main-title">
              {getLabelUpper("education", lang)}
            </h2>
              ...
              >
                <div className="entry-date">
                  <EditableText
                    ...
                    onChange={
                      onDataChange
                        ? (v) => updateEducation(index, "startDate", v)
                        : undefined
                    }
                    placeholder="Start"
                  />{" "}
                  ...
                  <EditableText
                    ...
                    onChange={
                      onDataChange
                        ? (v) => updateEducation(index, "endDate", v)
                        : undefined
                    }
                    placeholder="End"
                  />
                ...
                <div className="entry-content">
                  <EditableText
                    ...
                    onChange={
                      onDataChange
                        ? (v) => updateEducation(index, "institution", v)
                        : undefined
                    }
                  ...
                  <div className="entry-subtitle">
                    <EditableText
                      ...
                      onChange={
                        onDataChange
                          ? (v) => updateEducation(index, "degree", v)
                          : undefined
                      }
                      placeholder="Degree"
                    />
                    ...
                    <EditableText
                      ...
                      onChange={
                        onDataChange
                          ? (v) => updateEducation(index, "field", v)
                          : undefined
                      }
                      placeholder="Field"
                    />
                  ...
                  {(edu.description || onDataChange) && (
                    <EditableText
                      ...
                      onChange={
                        onDataChange
                          ? (v) => updateEducation(index, "description", v)
                          : undefined
                      }
              ...
              >
                <div className="entry-date">
                  <EditableText
                    ...
                    onChange={
                      onDataChange
                        ? (v) => updateExperience(index, "startDate", v)
                        : undefined
                    }
                    placeholder="Start"
                  />
                  {exp.endDate ? (
                    <>
                      ...
                      <EditableText
                        ...
                        onChange={
                          onDataChange
                            ? (v) => updateExperience(index, "endDate", v)
                            : undefined
                        }
                        placeholder="End"
                      />
                ...
                <div className="entry-content">
                  <EditableText
                    ...
                    onChange={
                      onDataChange
                        ? (v) => updateExperience(index, "company", v)
                        : undefined
                    }
                    placeholder="Company"
                  />
                  <EditableText
                    ...
                    onChange={
                      onDataChange
                        ? (v) => updateExperience(index, "position", v)
                        : undefined
                    }
        ...
        {showPublications && data.publications.length > 0 && (
          <section className="minimal-main-section">
            <h2 className="minimal-main-title">
              {getLabelUpper("publications", lang)}
            </h2>
            {data.publications.map((pub, i) => (
              <div
                key={pub.id}
                className="minimal-pub"
              >
                <EditableText
                  tag="span"
                  className="pub-date"
            ...
            {data.awards.map((award, i) => (
              ...
              >
                <EditableText
                  ...
                  value={award.date || ""}
                  onChange={
                    onDataChange ? (v) => updateAward(i, "date", v) : undefined
                  }
                  placeholder="Date"
                />
                <EditableText
                  ...
                  value={award.title || ""}
                  onChange={
                    onDataChange ? (v) => updateAward(i, "title", v) : undefined
                  }
                  placeholder="Award"
                />
              </div>
        ...
        {showCertificates && data.certificates.length > 0 && (
          <section className="minimal-main-section">
            <h2 className="minimal-main-title">
              {getLabelUpper("certificates", lang)}
            </h2>
              ...
              >
                ...
                <div className="entry-content">
                  ...
                  <EditableText
                    ...
                    onChange={
                      onDataChange
                        ? (v) => updateCertificate(i, "issuer", v)
                        : undefined
                    }
                    placeholder="Issuer"
                  />
            ...
            <div className="minimal-hobbies">
              {data.hobbies.map((hobby, i) => (
                <EditableText
                  ...
                  value={hobby.name || ""}
                  onChange={
                    onDataChange ? (v) => updateHobby(i, "name", v) : undefined
                  }
                  placeholder="Hobby"
                />
              ))}
