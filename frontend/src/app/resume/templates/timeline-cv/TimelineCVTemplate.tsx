        ...
        <div className="timeline-container" style={cssVars}>
            ...
            <aside className="timeline-sidebar">
                ...
                <div className="timeline-profile">
                    {personal.photo && (
                        <img src={personal.photo} alt="" className="timeline-photo" />
                    )}
                    <EditableText
                        tag="h1"
                ...
                {skills.length > 0 && (
                    <section className="timeline-section">
                        <h2 className="timeline-section-title">{getLabel('skills', lang)}</h2>
                        <div className="timeline-skills-list">
                            {skills.map((skill, i) => (
                                <div key={skill.id || i} className="timeline-skill-item">
                                    <EditableText
                                        tag="span"
                ...
                {languages.length > 0 && (
                    <section className="timeline-section">
                        <h2 className="timeline-section-title">{getLabel('languages', lang)}</h2>
                        <div className="timeline-languages">
                            {languages.map((langItem, i) => (
                                <div key={langItem.id || i} className="timeline-language-item">
                                    <EditableText
                                        tag="span"
            ...
            <main className="timeline-main">
                ...
                {experience.length > 0 && (
                    <section className="timeline-main-section">
                        <h2 className="timeline-main-title">{getLabel('experience', lang)}</h2>
                        <div className="timeline-entries">
                            {experience.map((exp, i) => (
                                <div key={exp.id || i} className="timeline-entry">
                ...
                {education.length > 0 && (
                    <section className="timeline-main-section">
                        <h2 className="timeline-main-title">{getLabel('education', lang)}</h2>
                        <div className="timeline-entries">
                            {education.map((edu, i) => (
                                <div key={edu.id || i} className="timeline-entry">
                                    <div className="timeline-date-col">
                                        <div className="timeline-date-present">
                                            <EditableText
                                                tag="span"
