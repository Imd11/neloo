...
export function ClassicCVTemplate({ data, style, onDataChange }: Props) {
  const { personal, experience, education, skills, languages, certificates } =
    data;
          ...
          <section className="classic-section">
            ...
            <div className="classic-languages">
              {languages.map((lang, i) => (
                <div
                  key={lang.id || i}
                  className="classic-language-row"
                >
                  <EditableText
                    tag="span"
            ...
            <div className="classic-certs">
              {certificates.map((cert, i) => (
                ...
                >
                  ...
                  />
                  <span className="classic-cert-issuer">
                    ,{" "}
                    <EditableText
                      tag="span"
                      value={cert.issuer || ""}
