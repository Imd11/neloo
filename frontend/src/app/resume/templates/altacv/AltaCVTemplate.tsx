...
export function AltaCVTemplate({
  data,
  style,
  onDataChange,
}: AltaCVTemplateProps) {
      ...
      <div className="altacv-main">
        ...
        <header className="altacv-header">
          ...
          <div className="altacv-contact-row">
            {(data.personal.email || onDataChange) && (
              <span className="altacv-contact-item">
                ✉{" "}
                <EditableText
                  tag="span"
        ...
        {data.experience.length > 0 && (
          <section className="altacv-section">
            <h2 className="altacv-section-title">
              {getLabel("experience", lang).toUpperCase()}
            </h2>
            {data.experience.map((exp, index) => (
              <div
                key={exp.id}
                className="altacv-entry"
              >
                <div className="altacv-entry-header">
                  ...
                  />
                  <span className="altacv-entry-location">
                    📍{" "}
                    <EditableText
                      tag="span"
                      value={exp.location || ""}
                      onChange={
                        onDataChange
                          ? (v) => updateExperience(index, "location", v)
                          : undefined
                      }
        ...
        {showProjects && data.projects.length > 0 && (
          <section className="altacv-section">
            <h2 className="altacv-section-title">
              {getLabel("projects", lang).toUpperCase()}
            </h2>
            {data.projects.map((proj, i) => (
              ...
              >
                ...
                <EditableText
                  ...
                  onChange={
                    onDataChange
                      ? (v) => updateProject(i, "organization", v)
                      : undefined
                  }
                ...
                <EditableText
                  ...
                  onChange={
                    onDataChange
                      ? (v) => updateProject(i, "description", v)
                      : undefined
                  }
        ...
        {(data.personal.philosophy || onDataChange) && (
          <section className="altacv-sidebar-section">
            ...
            <EditableText
              ...
              value={
                data.personal.philosophy ? `"${data.personal.philosophy}"` : ""
              }
              onChange={
                onDataChange
                  ? (v) => updatePersonal("philosophy", v.replace(/^"|"$/g, ""))
                  : undefined
              }
              ...
              >
                ...
                {(edu.description || onDataChange) && (
                  <EditableText
                    ...
                    onChange={
                      onDataChange
                        ? (v) => updateEducation(i, "description", v)
                        : undefined
                    }
                    placeholder="Description"
                  />
