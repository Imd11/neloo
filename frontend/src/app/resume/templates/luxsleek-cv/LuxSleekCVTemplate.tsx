    ...
    >
      ...
      <aside className="luxsleek-sidebar">
        ...
        <section className="luxsleek-section">
          <h2 className="luxsleek-section-title">
          ...
          <section className="luxsleek-section">
            ...
            <div className="luxsleek-languages">
              {languages.map((langItem, i) => (
                <div
                  key={langItem.id || i}
                  className="luxsleek-language-item"
                >
                  <EditableText
                    tag="span"
      ...
      <main className="luxsleek-main">
        ...
        {experience.length > 0 && (
          <section className="luxsleek-main-section">
            <h2 className="luxsleek-main-title">
              ...
              {experience.map((exp, i) => (
                ...
                >
                  <div className="luxsleek-entry-header">
                    ...
                    />
                    <span className="luxsleek-entry-company">
                      {" "}
                      at{" "}
                      <EditableText
                        tag="span"
                  ...
                  <p className="luxsleek-publication">
                    ...
                    <em>
                      <EditableText
                        ...
                        onChange={
                          onDataChange
                            ? (v) => updatePublication(i, "publisher", v)
                            : undefined
                        }
