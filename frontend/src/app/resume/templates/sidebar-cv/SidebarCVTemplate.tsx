...
export function SidebarCVTemplate({
  data,
  style,
  onDataChange,
}: SidebarCVTemplateProps) {
  ...
  return (
    <div
      className="sidebar-cv-container"
      style={cssVars}
    >
      {/* Left Sidebar */}
      <aside className="sidebar-cv-left">
        ...
        <section className="sidebar-cv-section">
          <div className="section-header">
            <span className="section-icon">🎓</span>
            <span className="section-title">
              {getLabel("education", lang).toUpperCase()}
            </span>
          </div>
        ...
        {data.skills.length > 0 && (
          <section className="right-section">
            ...
            <div className="fields-grid">
              {data.skills
                .filter((s) => s.category === "domain" || true)
                .slice(0, 3)
                .map((skill, i) => (
                  <div
                    key={skill.id}
