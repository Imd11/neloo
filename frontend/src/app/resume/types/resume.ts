...
export const defaultResumeData: ResumeData = {
  personal: {
    ...
    summary:
      "Passionate panda scientist with expertise in bamboo research and conservation.",
  },
  socialLinks: [
  ...
  experience: [
    {
      ...
      current: true,
      description:
        "Chief executive officer, Head developer of yoga and meditation apps.",
      highlights: [],
    },
    {
      id: "2",
  ...
  awards: [
    {
      id: "1",
      title: "Panda of the Year",
      issuer: "Panda World Forum",
      date: "2019",
      description: "",
    },
  ],
  publications: [
    {
      id: "1",
      title: "Cooking: 100 recipes for lazy Pandas",
      authors: "Me and My Panda Friends",
      publisher: "Panda Culinary",
      date: "2010",
      url: "",
      description: "",
    },
