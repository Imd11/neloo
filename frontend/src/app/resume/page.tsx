...
export function ResumePageContent({ onExit }: { onExit?: () => void } = {}) {
  ...
  const [activeTemplate, setActiveTemplate] =
    useState<TemplateId>("forty-seconds-cv");
        ...
        {isInputMode || isParsingMode ? (
          ...
          >
            ...
            <div className="flex flex-1 flex-col items-center px-6">
              <div className="flex w-full max-w-4xl flex-col items-center gap-6 pt-[10vh]">
                {/* Header */}
                ...
                <div className="w-full max-w-xl">
                  {isParsingMode ? (
                    // Parsing Status
                    <div className="border-primary/50 bg-primary/5 rounded-2xl border-2 border-dashed p-8 text-center">
                    ...
                    <div
                      ...
                      className={cn(
                        ...
                        dragActive
                          ...
                          : "hover:border-primary/50 border-border hover:bg-muted/50"
                      )}
                    >
                      <input
                        ref={fileInputRef}
                      ...
                      {uploadedFile ? (
                        ...
                        <>
                          ...
                          <button
                            ...
                            className="text-primary-foreground hover:bg-primary/90 rounded-full bg-primary px-4 py-1.5 text-sm font-medium transition-colors"
                          >
                            选择文件
                          </button>
                        </>
                  ...
                  {isInputMode && (
                    <div className="mt-4 text-center">
                      <button
                        onClick={handleSkip}
                        className="hover:border-primary/50 rounded-lg border border-border px-6 py-2 text-sm text-muted-foreground transition-colors hover:text-foreground"
                      >
                        跳过，手动填写简历 →
                      </button>
                    </div>
