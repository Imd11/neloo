...
export const CHAT_MODELS: ModelInfo[] = [
    ...
    { id: "qwen", name: "Qwen3 Max", logo: "/logos/qwen.png", provider: "Alibaba Cloud" },
    { id: "minimax", name: "MiniMax M2.1", logo: "/logos/minimax.png", provider: "MiniMax" },
    ...
    { id: "gemini", name: "Gemini 3 Pro", logo: "/logos/gemini.png", provider: "Google" },
    { id: "zhipu", name: "GLM-4.7", logo: "/logos/glm.png", provider: "Zhipu AI" },
    { id: "openrouter", name: "Llama 4 Maverick", logo: "/logos/llama.png", provider: "Meta via OpenRouter" },
...
export const IMAGE_MODELS: ModelInfo[] = [
    { id: "nano-banana", name: "Nano Banana", logo: "/logos/nano-banana.png", provider: "Nano Banana" },
