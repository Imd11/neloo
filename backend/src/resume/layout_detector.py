...
class LayoutDetector:
    ...
    def __init__(self, model_path: Optional[str] = None):
        ...
        if model_path and os.path.exists(model_path):
            ...
            print(f"⚠️ Layout model not found. Layout detection will be disabled.")
            print(f"   To enable, download YOLOv10 model to: models/yolov10/best.onnx")
    ...
    def _download_model(self, target_path: str) -> bool:
        ...
        try:
            ...
            print(f"   Layout detection will be disabled.")
            return False
...
def convert_pdf_page_to_image(pdf_bytes: bytes, page_num: int = 0, dpi: int = 150) -> Optional[np.ndarray]:
    """
