...
def extract_text_from_index_range(
    text_lines: List[str],
    index_range: Optional[List[int]]
) -> str:
...
def map_work_experience(
    smart_resume_data: Dict[str, Any],
    text_lines: List[str]
) -> List[Dict[str, Any]]:
    ...
    for exp in work_exp:
        ...
        result.append({
            ...
            "description": extract_text_from_index_range(
                text_lines,
                exp.get("jobDescription_refer_index_range")
            ),
            "highlights": [],
        })
...
def map_projects(
    ...
    for proj in projects:
        ...
        result.append({
            ...
            "description": extract_text_from_index_range(
                text_lines,
                proj.get("description_refer_index_range")
            ),
            "highlights": [],
...
def convert_to_resume_data(
    smart_resume_output: Dict[str, Any],
    text_lines: List[str]
) -> Dict[str, Any]:
    """
