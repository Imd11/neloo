...
| الصور | `GEMINI_IMAGE_API_KEY`, `GEMINI_IMAGE_MODEL`, `OPENAI_API_KEY`, `OPENAI_IMAGE_MODEL` | يستخدم Nano Banana 2 نموذج `gemini-3.1-flash-image` افتراضياً؛ هذه متغيرات خادم. |
